        ...
        <li><a href="index.php"><span class="glyphicon glyphicon-home" aria-hidden="true"></span></a></li>
         <li class="dropdown">
          ...
          <ul class="dropdown-menu">
		  	<li><a href="manusuario.php" target="main"><span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span> Usuarios</a></li>
			<li><a href="manempleado.php" target="main"><span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span> Trabajadores</a></li>
          </ul>
        </li>
