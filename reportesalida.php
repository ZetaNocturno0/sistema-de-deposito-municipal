...
<script language="javascript">	
	...
	function BuscarF(f)
	{
			f.action='reportesalida.php'; //listar
			f.submit();
			return true;
	}
...
<div class="form-group">
  <h4 class="Estilo3">REPORTE DE SALIDAS<a href="contenido.php" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></a></h4> 
</div>
	...
	<table class="table table-striped table-bordered nowrap">
  	...
  	<tr >
        ...
        <tr>
          <td><table width="1155">
            ...
            <button type="button" name="lanzador1" id="lanzador1" class="btn btn-warning"><span class="glyphicon glyphicon-calendar" aria-hidden="true"/></button>
           ...
           <button type="button" name="lanzador2" id="lanzador2" class="btn btn-warning"><span class="glyphicon glyphicon-calendar" aria-hidden="true"/></button>
			<script type="text/javascript">
				    Calendar.setup(
					  {
				 ...
				 <button type="button" name="BtnBuscar2" id="BtnBuscar2" onClick="BuscarF(this.form)"class="btn-lg btn-danger"><span class="glyphicon glyphicon-search" aria-hidden="true"/></button>
  	...
  	<tr>
        ...
        <tr id="color3">
          <td width="118" height="18" align="center"  >INTERNAMIENTO</td>
          <td width="83" align="center" >PAPELETA</td>
          <td width="71" align="center" >PLACA</td>
		  <td width="71" align="center"  >COLOR</td>
          <td width="145" align="center"  >Fecha Hora Sal. </span></td>
          <td width="108" align="center"  ># RECIBO </td>
          <td width="343" align="center"  >Resp. del Pago</td>
          <td width="80" align="center"  >DNI</td>
		  <td width="106" align="center"  >USUARIO</td>
          <td width="84" align="center"  >ESTADO</td>
		    	   ...
		    	   if($criterio=="" && $crit=="")
					{
					   $listavent = $objs->ListarTodo(); 
						  ...
						  if($criterio!="" && $crit=="") {
							   $listavent = $objs->ListarPorPlaca($criterio);
						  }else{ 
								 $listavent = $objs->ListarPorPapeleta($crit);
							   }		             	
						 }	 
			    }else{
        ...
        <tr>
          ...
          <td align="left" >
            <span class="Estilo4">
            <div align="center">
			  <?=$listaventa[$i]["salida_fecha"]." / ".$listaventa[$i]["salida_hora"];?>         
            </div></td>
          <td align="left" >
            <span class="Estilo4">
            <div align="center">
              <?=$listaventa[$i]["recibo_numero"];?>          
            </div></td>
          <td align="left" >
            <span class="Estilo4">
            <div align="center">
			  <?=$listaventa[$i]["pagador_nombre"]." ".$listaventa[$i]["pagador_apellido_paterno"]." ".$listaventa[$i]["pagador_apellido_materno"];?>     
            </div></td>
          <td align="left" >
            <span class="Estilo4">
            <div align="center">
              <?=$listaventa[$i]["pagador_dni"];?>          
            </div></td>
			<td align="left" >
            <span class="Estilo4">
            <div align="center">
          ...
          <td width="55" align="center"><a href="javascript:envia('<?=$listaventa[$i]["id_internamiento"];?>');" ><span style="color:#FF6600" title="Imprimir" class="glyphicon glyphicon-print" aria-hidden="true"></span></a></td>
